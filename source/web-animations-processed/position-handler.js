...
export var mergeOffsetList = mergeNestedRepeated.bind(null, mergeDimensions, ' ');
export function consumePosition(string) {
  var result = consumeRepeated(consumeOffset, /^/, string);
  if (!result) {
    return;
  }
...
export var positionhandler = [[parseOrigin.bind(null, 3), mergeOffsetList, ['transform-origin']], [parseOrigin.bind(null, 2), mergeOffsetList, ['perspective-origin']], [parsePositionList, mergePositionList, ['background-position', 'object-position']]];