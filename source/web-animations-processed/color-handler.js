...
import { clamp } from './hyper-linked.js';
...
export var consumeColor = consumeParenthesised.bind(null, parseColor);
...
export var colorhandler = [[parseColor, mergeColors, ['background-color', 'border-bottom-color', 'border-left-color', 'border-right-color', 'border-top-color', 'color', 'fill', 'flood-color', 'lighting-color', 'outline-color', 'stop-color', 'stroke', 'text-decoration-color']]];