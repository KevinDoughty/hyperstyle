...
import { numberToString } from './hyper-linked.js';
...
export function mergeDimensions(left, right, nonNegative) {
  var units = [],
      unit;
...
export var parseLength = parseDimension.bind(null, new RegExp(lengthUnits, 'g'));
export var parseLengthOrPercent = parseDimension.bind(null, new RegExp(lengthUnits + '|%', 'g'));
export var parseAngle = parseDimension.bind(null, /deg|rad|grad|turn/g);
export var consumeLengthOrPercent = consumeParenthesised.bind(null, parseLengthOrPercent);
...
export var consumeSizePairList = consumeRepeated.bind(undefined, consumeSizePair, /^,/);
