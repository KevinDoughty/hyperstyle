...
export function consumeToken(regex, string) {
...
export function consumeTrimmed(consumer, string) {
...
export function consumeRepeated(consumer, separator, string) {
...
export function consumeParenthesised(parser, string) {
  var nesting = 0;
...
export function consumeList(list, input) {
  var output = [];
...
export function mergeWrappedNestedRepeated(wrap, nestedMerge, separator, left, right) {
  var matchingLeft = [];
  var matchingRight = [];
  var reconsititution = [];
...
export function mergeList(left, right, list) {
  var lefts = [];
  var rights = [];
  var functions = [];
  var j = 0;
...
export var mergeNestedRepeated = mergeWrappedNestedRepeated.bind(null, null);
export var handlerutils = [];