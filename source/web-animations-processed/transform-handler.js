...
import { transformListToMatrix } from './hyper-linked.js';
import { mergeDimensions } from './hyper-linked.js';
import { mergeNumbers } from './hyper-linked.js';
import { composeMatrix } from './hyper-linked.js';
import { quat } from './hyper-linked.js';
import { makeMatrixDecomposition } from './hyper-linked.js';
import { parseLength } from './hyper-linked.js';
import { parseLengthOrPercent } from './hyper-linked.js';
import { parseNumber } from './hyper-linked.js';
import { parseAngle } from './hyper-linked.js';
...
export var transformToSvgMatrix = function (string) {
  // matrix(<a> <b> <c> <d> <e> <f>)
...
export var transformhandler = [[parseTransform, mergeTransforms, ['transform']]];