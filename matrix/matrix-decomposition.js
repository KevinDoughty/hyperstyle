...
// https://github.com/web-animations/web-animations-js/blob/dev/src/matrix-decomposition.js
...
const WEB_ANIMATIONS_TESTING = true;
...
export function makeMatrixDecomposition(transformList) {
