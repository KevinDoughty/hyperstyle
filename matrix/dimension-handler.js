...
import { numberToString } from "./number-handler.js";
import { consumeParenthesised, consumeRepeated, mergeNestedRepeated } from "./handler-utils.js";
...
export const consumeSizePairList = consumeRepeated.bind(undefined, consumeSizePair, /^,/);
...
export const mergeNonNegativeSizePair = mergeNestedRepeated.bind(undefined, mergeDimensionsNonNegative, ' ');
var mergeNonNegativeSizePairList = mergeNestedRepeated.bind(undefined, mergeNonNegativeSizePair, ',');

export const consumeLengthOrPercent = consumeParenthesised.bind(null, parseLengthOrPercent);
